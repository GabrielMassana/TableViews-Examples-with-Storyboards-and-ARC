...
//
//  Created by Jose Antonio Gabriel Massana on 11/07/13.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    myTableViewCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    myTableViewCell.textLabel.text = [tableData objectAtIndex:indexPath.row];
